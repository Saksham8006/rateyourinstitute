    ...
    return (
        ...
        <>
            ...
            <div id="drawer-right-example"
                className="fixed top-0 right-0 bottom-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-gray-500 w-80 border border-red-400"
                ...
                <button onClick={() => handleToggle} type="button" data-drawer-hide="drawer-right-example" aria-controls="drawer-right-example" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
